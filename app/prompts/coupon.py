"""
System prompt for the COUPON use-case.

This is the production prompt that has been tested and verified to generate
high-quality coupon/deal banners with accurate text, proper branding, and
no trademark hallucinations.

Handles: BOGO, flat discounts, percentage off, combos, visit-based rewards, etc.
"""
